class LevelFour extends Phaser.Scene {
  ...
  create() {
    ...
    var plat1 = this.physics.add.image(150, 200, 'ground')
      .setImmovable(true)
      .setScale(0.5);
    var plat2 = this.physics.add.image(400, 200, 'ground')
      .setImmovable(true)
      .setScale(0.5);
    var plat3 = this.physics.add.image(650, 200, 'ground')
      .setImmovable(true)
      .setScale(0.5);
    var plat4 = this.physics.add.image(150, 300, 'ground')
      .setImmovable(true)
      .setScale(0.5);
    var plat5 = this.physics.add.image(400, 300, 'ground')
      .setImmovable(true)
      .setScale(0.5);
    var plat6 = this.physics.add.image(650, 300, 'ground')
      .setImmovable(true)
      .setScale(0.5);
    var plat7 = this.physics.add.image(150, 400, 'ground')
      .setImmovable(true)
      .setScale(0.5);
    var plat8 = this.physics.add.image(400, 400, 'ground')
      .setImmovable(true)
      .setScale(0.5);
    var plat9 = this.physics.add.image(650, 400, 'ground')
      .setImmovable(true)
      .setScale(0.5);
